 ...
 * column, and value)
 */
public class KVMapperOnCSVIn extends
  ...
  protected void map(LongWritable key, Text value, Context context)
    ...
    try {
      ...
      context.getCounter("KVMapperOnCSVIn", "PARSE_ERRORS").increment(1);
      return;
    }

    if (fields.length != NUM_FIELDS) {
      context.getCounter("KVMapperOnCSVIn", "INVALID_FIELD_LEN").increment(1);
      return;
    }
    ...
    try {
      ...
      context.getCounter("KVMapperOnCSVIn", "INVALID_DATE").increment(1);
      return;
    }
    ...
    context.getCounter("KVMapperOnCSVIn", "NUM_MSGS").increment(1);
